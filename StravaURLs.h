...
class StravaURLs {
    public:
        ...
        std::string stravaOAuth = "http://www.strava.com/oauth/authorize?client_id=" + AuthorizationTokens::getClientID() +"&response_type=code&redirect_uri=http://localhost/exchange_token&approval_prompt=force&scope=read";
};
